...
class IndexController extends BaseController
{
	...
	public function index()
    {
        ...
        $banner_arr = $this->banner->getList(BannerEnum::INDEX);


        //今日热招
        $where2['is_recommend'] = BasicEnum::ACTIVE;
        $recruit_arr = $this->recruit->getList($where2,4);

        //推荐企业
        $recommend_arr = $recruit_arr;

        //门店服务
        $where3['is_recommend'] = BasicEnum::ACTIVE;
        ...
        $where5['category_id'] = $category_id1;
        ...
        $where6['category_id'] = $category_id2;
