...
@section('content')
    <div class="w1200 of_hide reg_main">
        <div class="left reg_left">
            ...
            <form role="form" action="http://www.gonglf.com/Login/reg.html" method="post" id="form">
                <table class="reg_lcont font_16" cellspacing="20">
                    <tbody>
                    <tr>
                        <td class="reg_label">手机号</td>
                        <td>
                            <input type="text" name="mobile" class="reg_input" id="inputMobile" placeholder="输入手机号">
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <div class="right"><img src="./【电子厂招聘_普工招工网_工厂直招信息平台】-工立方打工网_files/regSms_.html"
                                                    onclick="refreshVerify()" height="47" style="cursor:pointer;"
                                                    id="imgVerify" data-ajax="/Public/checkCode.html"></div>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="password" name="password" class="reg_input" id="inputPassword" placeholder="输入密码">
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="password" name="repassword" class="reg_input" id="rePassword" placeholder="输入确认密码">
                        </td>
                        <td class="reg_tip">输入确认密码</td>
                    </tr>
                    <tr>
                        <td></td>
                        <td class="grey"><label><input type="checkbox" name="agreement" onchange="agreeInput()" value="1"
                                                       checked="">点击注册表示您已经阅读并同意</label><a
                                    href="javascript:agreement(&#39;/Login/agreement.html&#39;)" data-href=""
                                    style="color:#3a84cf;">《工立方用户协议》</a></td>
                        <td></td>
                    </tr>
                    <tr>
                        <td></td>
                        <td class="grey">
                            <a href="javascript:reg()" class="reg_btn mt_30" id="regbtn">注册</a>
                            <!-- <input type="submit" value="注册" class="reg_btn mt_30" id="regbtn" style="border:0;font-size:16px;cursor:pointer;font-weight:bold;" /> -->
                        </td>
                        <td></td>
                    </tr>
                    </tbody>
