...
@section('content')
    ...
    <section class="content">
        <div class="row">
            <div class="col-md-12">
                <div class="box">
                    <form class="form-horizontal J_ajaxForm" style="margin:10px 20px;" role="form" id="form" action="{{url('admin/label',array($data->id))}}" method="post">
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label">标签位置</label>
                            <div class="col-sm-8">
                                {{\App\Enums\LabelEnum::enumSelect($data->type,false,'type')}}
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="box-footer">
                            ...
                            <div class="col-xs-2 col-md-1">
                                <a href="{{url('admin/label')}}" class="btn btn-default">取消</a>
                            </div>
                        </div>
                    </form>
                </div>
